            ...
            <div className="isolate bg-white px-6 py-10 sm:py-12 border border-[#00000040] shadow-sm rounded-2xl">
              ...
              >
                ...
                <div className="mt-8 text-center">
                  <button
                    type="submit"
                    className="inline-block rounded-md bg-[#236EDE] px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600"
                  >
                    Submit
                  </button>
                </div>
