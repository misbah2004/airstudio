     ...
     <>
       <div className='flex flex-col justify-center items-center'>
        <div className='flex flex-col justify-center items-center'>
            ...
            <span className='text-[#858585] text-center'>Hear from our early adopters about their experience with out products.</span>
        </div>
        <div className='flex space-x-2 mt-2 flex-col lg:flex-row p-5 gap-5'>
