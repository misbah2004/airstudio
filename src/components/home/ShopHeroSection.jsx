  ...
  return (
    <>
      <div className='h-[450px] p-1 flex justify-center'>
        <div className='w-xs '>
          <img src="/assets/images/bannerheadphone.jpeg" alt="" className='h-15 w-15 rounded-[100%] mt-20 float-end object-cover ' />
          <img src="/assets/images/shopheroimg.png" alt="" className='' />
        </div>
        <div className='w-2xl mt-[15%] flex flex-col justify-center items-center'>
          <h1 className='text-[#FFB53F] text-5xl font-semibold'>{heading }</h1>
          <p className='text-center text-[#858585] text-[20px]'>Lorem Ipsum is simply dummy text of the printing and typesetting <br /> industry. Lorem Ipsum has been the industry's standard dummy text ever <br /> since the 1500s,
          </p>
        </div>
        <div className='w-xs'>
